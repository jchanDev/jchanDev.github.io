...
export function Project3() {
  return (
    <Terminal title="~/projects/project_three">
      <div className="space-y-6">
        ...
        <div>
          <h1 className="text-purple-700 dark:text-purple-300 mb-2">PROJECT_THREE.exe</h1>
        ...
        <div className="space-y-4">
          <div className="bg-white/50 dark:bg-slate-800/50 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-700">
            ...
            <p className="ml-4">
              Tell the story of your third project. What was the biggest challenge? 
              What did you learn? How does this project showcase your skills and 
              creativity? Make it personal and engaging.
            </p>
          </div>
          ...
          <div className="bg-white/50 dark:bg-slate-800/50 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-700">
            ...
            <div className="ml-4 flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-purple-200 dark:bg-purple-800 rounded-full text-sm">Next.js</span>
              <span className="px-3 py-1 bg-purple-200 dark:bg-purple-800 rounded-full text-sm">GraphQL</span>
              <span className="px-3 py-1 bg-purple-200 dark:bg-purple-800 rounded-full text-sm">MongoDB</span>
              <span className="px-3 py-1 bg-purple-200 dark:bg-purple-800 rounded-full text-sm">AWS</span>
            </div>
          </div>
          ...
          <div className="bg-white/50 dark:bg-slate-800/50 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-700">
            ...
            <ul className="ml-4 space-y-1 list-disc list-inside">
              ...
              <li>Design highlight</li>
              <li>User engagement feature</li>
            </ul>
          </div>
          ...
          <div className="flex gap-4 mt-6">
            ...
            <a
              href="https://your-project-three-demo.com"
              target="_blank"
              rel="noopener noreferrer"
