...
export function Project2() {
  return (
    <Terminal title="~/projects/project_two">
      <div className="space-y-6">
        ...
        <div>
          <h1 className="text-purple-700 dark:text-purple-300 mb-2">PROJECT_TWO.exe</h1>
        ...
        <div className="space-y-4">
          <div className="bg-white/50 dark:bg-slate-800/50 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-700">
            ...
            <p className="ml-4">
              Describe your second project here. What was your inspiration? 
              What makes this project unique? Share the story behind its creation 
          ...
          <div className="bg-white/50 dark:bg-slate-800/50 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-700">
            ...
            <div className="ml-4 flex flex-wrap gap-2">
              <span className="px-3 py-1 bg-purple-200 dark:bg-purple-800 rounded-full text-sm">Vue.js</span>
              <span className="px-3 py-1 bg-purple-200 dark:bg-purple-800 rounded-full text-sm">Python</span>
              <span className="px-3 py-1 bg-purple-200 dark:bg-purple-800 rounded-full text-sm">PostgreSQL</span>
              <span className="px-3 py-1 bg-purple-200 dark:bg-purple-800 rounded-full text-sm">Docker</span>
            </div>
          </div>
          ...
          <div className="bg-white/50 dark:bg-slate-800/50 p-4 rounded-lg border-2 border-purple-200 dark:border-purple-700">
            ...
            <ul className="ml-4 space-y-1 list-disc list-inside">
              <li>Key feature that stands out</li>
              <li>Innovative solution implemented</li>
          ...
          <div className="flex gap-4 mt-6">
            ...
            <a
              href="https://your-project-two-demo.com"
              target="_blank"
              rel="noopener noreferrer"
